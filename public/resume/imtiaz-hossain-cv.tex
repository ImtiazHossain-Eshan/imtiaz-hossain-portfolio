...
\textbf{Multi-Portrait Biometric Unlinkability under Generative Editing.} Working paper, 2026. Single-author manuscript in preparation; full methods and quantitative results remain restricted.
...
Four-time scholarship recipient based on merit and prior academic results \enspace|\enspace Final-round participant, Bit Battles Programming Contest \enspace|\enspace Solved 233+ algorithmic problems on LeetCode \enspace|\enspace IELTS overall band 7\\
Understanding Machine Learning, Data Manipulation in Python, and Cleaning Data in Python - DataCamp
